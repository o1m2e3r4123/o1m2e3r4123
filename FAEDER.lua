...
-- All The File By Developer Faeder : @xxxeexx
-- Join In Chennel Source : @d6yyt 
-- Join In Explanation Channel : @d6tth
----------------------------------------------------------------------------
...
if res ~= 200 then
io.write("\27[31;47m◼¦ حدث خطأ في الاتصال بالسيرفر ، يرجى مراسلة مطور السورس { @xxxeexx } ليتمكن من حل المشكلة في اسرع وقت ممكن! \27[0;m\n")
os.exit()
end
Getresult, Getuser = pcall(JSON.decode, url)
if not Getresult then
io.write("\27[31;47m◼¦ حدث خطأ في سكرب الاستخراج ، يرجى مراسلة مطور السورس { @xxxeexx } ليتمكن من حل المشكلة في اسرع وقت ممكن! \27[0;m\n")
os.exit()
end
...
name_bot = (faederdx1:get(FAEDER..'name_bot') or 'سلطان')
...
faederdx113(chat,msg.id_,"*❅∫ هذا الملف ليس تابع لسورس سلطان ،*")   
return false 
end      
...
faederdx(msg.chat_id_, msg.id_, 1, '❅∫ *العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'd6yyt')..')'..' )\n❅∫ *تم رفعه ( '..faederrt..' )\n❅∫ *بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
...
if fdrt == "مميز" and is_momod(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '❅∫ العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'd6yyt')..')'..' )\n❅∫ تم رفعه ( '..text1[2]..' )\n❅∫ بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
...
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "d6yyt")}}}
local Sudo_Welcome = '❅∫ يمكنك ايضا استخدام الاوامر الخدميه \n❅∫ اليك ازرار الاوامر الخدميه اسفل الرساله\n                  • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n                              [𝐅𝐀𝐄𝐃𝐄𝐑 - 𝐂𝐇](https://t.me/d6yyt)'
local key = {
{'زخرفه','احسب عمرك'},
{'الابراج','نسبه الحب'},
{'قسم الحمايه'},
...
keyboard = {} -- الحقوق محفوظه لسورس سلطان لتخمط بدون ذكر المصدر
...
local text = text:gsub('user',(result.username_ or 'd6yyt'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end 
...
local text = text:gsub('user',(msg.content_.members_[0].username_ or 'd6yyt'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
--     By Developer Faeder     -- 
-------- Contact
...
local text = text:gsub('username',(result.username_ or 'd6yyt'))
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end 
...
if text == 'سورس سلطان' or text == 'سورس ديف سلطان' or text == 'سورس انور'  then if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then faeder =  "تااج وباجج حبيي ، 😹🌝" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end 
...
if text == 'بوت' and faeder11(msg) then  name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'سلطان')  local faeder = {  "أسمي "..name_bot.." يعمري ",  "أسمي "..name_bot.." يقميل ",  "تره أسمي "..name_bot.." كافي بوت ",  "انت البوت لك اسمي "..name_bot.." ", }  faeder2 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faeder2] , 1, 'md')  end
if (text and text == (faederdx1:get('faeder:'..bot_id..'name_bot') or 'سلطان')) then name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'سلطان') local namebot = {  'عيون '..name_bot..' العسليات ؛🤭☄',  'اطلقق من يصيح '..name_bot..' ؛😻💗',  'وياك '..name_bot..' عمري أمرني 🌾' } name = math.random(#namebot) faederdx(msg.chat_id_, msg.id_, 1, namebot[name] , 1, 'md') return false end
--     By Developer Faeder     -- 
...
name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'سلطان')
...
local inline = {
{{text="- قناة السورس ،",url="t.me/d6yyt"},
{text="- مبرمج السورس،",url="t.me/xxxeexx"}},
{{text="- اضغط هنا لتنصيب السورس ،",url="t.me/d6yyt"}},
{{text="- كروب المبرمجين ،",url="https://t.me/d6tth"},
{text="- شروحات السورس ،",url="t.me/d6tth"}}
}
send_inline(msg.chat_id_,'❅∫ مرحبا بك في سورس سلطان┋FAEDER ،\n❅∫ اضغط على الازرار بالاسفل ⬇️ ،',nil,inline) 
return false 
end
--     By Developer Faeder     -- 
...
faederdx1:set(FAEDER.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "@d6yyt")) 
faederdx(msg.chat_id_, msg.id_, 1, "❅∫ المنشئ ⌯» ["..monsh.."]\n\n❅∫ الرابط ، ["..title_name(chattid).."]("..(t2.invite_link_ or "t.me/d6yyt")..")\n❅∫ ايديها ⌯» *"..msg.chat_id_.."*\n❅∫ عدد الاعضاء ⌯» *"..data.member_count_.."* \n❅∫ عدد المدراء ⌯» *"..Owner.."*\n❅∫ عدد المنشئين ⌯» *"..Monsh.."*\n❅∫ عدد الادمنيه ⌯» *"..Momod.."*\n❅∫ عدد المكتومين ⌯» *"..Muted.."*\n❅∫ عدد المحظورين ⌯» *"..Baned.."*\n❅∫ عدد المقيدين ⌯» *"..Tkeed.."*\n❅∫ عدد المميزين ⌯» *"..Vip.."*\n", 1,"md")
end
tdcli_function ({
ID = "GetChannelFull",
...
local list = faederdx1:smembers(FAEDER.."bot:groups")
local text = "~ Groups_Bots_In_the_Bot_Of_Source_Faeder ~ @d6yyt\n\n"
for k,v in pairs(list) do
