...
return sendMsg(msg.chat_id_,msg.id_,"المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "d6yyt"))
end
end
...
return '👨🏾‍🔧¦ اصدار سورس السلطان : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://d6yyt.github.io/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس السلطان يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="t.me/d6yyt"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الـزعـيـم](t.me/d6yyt)',nil,inline,msg.id_)
return false
end
...
🌐┇BOSS TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📬┇ [Source Channel](https://t.me/d6yyt)

📊┇ [Source Install](https://t.me/d6yyt/4121)
...
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://d6yyt.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/d6yyt/d6yyt.github.io/master/plugins/"..FileName)
if res == 200 then
